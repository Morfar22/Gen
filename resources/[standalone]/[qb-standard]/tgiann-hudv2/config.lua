--[[ 
    client event list
        ...
        tgiann-hud:cruise
        TriggerEvent("tgiann-hud:cruise", 100)

]]

config = {}
config.framework = "qb" -- false - "esx" - "qb"
...
config.activeCommands = true
config.MPH = true
config.speedUpdateUI = 50
config.seatbeltKey = "b" -- https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
config.cruiseKey = "y" -- https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/

config.beltActiveDisableFKey = false
config.noBeltEjectMinSpeed = 5000
config.minimapAlwaysOpen = false

-- QB Stress settings
config.stressActive = false -- Only works in qb(You can adapt it to your system if you want. Check line 52)
