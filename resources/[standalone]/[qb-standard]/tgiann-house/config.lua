...
Config.mysql = "oxmysql" -- "oxmysql"    -   "mysql"  [Don't forget to edit the fxmanifest file]
Config.command = "house"
Config.policeJobs = {"police", "police2"}
Config.esxStashPutWeapon = true -- If your weapons are not items, set this setting to true (Disable)
...
--if you are using qb set this setting to "player_vehicles"
Config.vehicleTableName = "player_vehicles" -- "owned_vehicles"    -   "player_vehicles"
