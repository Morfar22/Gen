...
Config.Framework = {							-- ESX/QBCore configs
	...
	['account_trucker'] = 'bank',				-- Change here the account that should be used for truck driver expenses
}
...
Config.job = false								-- Required job name to open the menu (set as false to disable the permission). Set "trucker" to be a job
...
Config.jobs = {
	['cancel_job'] = 45,						-- Key to cancel the active job (167 = F6)(45 = R) [Hold key 2 seconds]
	['cooldown'] = 1, 							-- Cooldown time (in minutes) to generate a new contract
	['price_per_km_min'] = 110,					-- Minimum price per kilometer of the contract
	['price_per_km_max'] = 210,					-- Maximum price per kilometer of the contract
	...
	['max_contratos_ativos'] = 75,				-- Maximum of contracts that can be active, this means that when generating a contact that exceeds this number, the oldest contract will be deleted
	['available_trucks'] = {					-- List of trucks that are generated in contracts
		"hauler","phantom","packer",
	},
...
Config.drivers = {
	...
	['hiring_costs'] = {						-- Cost of hiring the driver (this amount will only be paid at the time of hiring)
		['min'] = 50000,							-- This is the minimum base cost of hiring the employee
		['max'] = 125000,							-- This is the maximum base cost of hiring the employee (this amount will increase according to the employee's skills)
		['percentage_skills'] = 12,				-- This is the % cost that each skill will add to the cost of hiring the driver. That is, for each skill level the driver has, this percentage will increase. (In this case, each skill will increase the cost by 25%)
	},
	...
	['available_drivers'] = {
		...
		{img = "https://bootdey.com/img/Content/avatar/avatar3.png", names = {"Joice Campos","Melanie Rebotim","Berenice Holanda","Maite Lage","Eduarda Barbosa","Livia Martins","Melissa Fernandes","Isabela Castro","Leila Fernandes","Letícia Correia","Melissa Cunha","Gabriela Azevedo"}},
	...
	['max_drivers_per_player'] = 8				-- Maximum number of drivers the player can hire
}
...
Config.driver_jobs = {
	...
	['profit'] = {								-- These are the drivers' earnings for each contract, a random value is generated for each contract
		...
		['max'] = 1500,							-- Maximum base profit, this will be the maximum amount of money this driver can generate (this amount will increase according to the driver's skills)
...
Config.sell_price_multiplier = 0.65				-- Value you receive when selling the used truck
Config.dealership = {							-- Truck dealership vehicles
	-- Here you can configure the vehicles of the dealership
	['phantom'] = { 								-- This should be the vehicle's spawn name
		['name'] = 'MTL Phantom',		-- Truck name
		['price'] = 310000,						-- Value
...
Config.loans = {
	...
	['amount'] = {
		...
		[1] = {240000,8000,5500},
		[2] = {500000,16667,11667},
		[3] = {750000,25000,15000},
		[4] = {1000000,33333,13333}
	}
}
...
Config.party = {
	...
	['party_money_bonus'] = 15,		-- Bonus money (in %) that each party member receives upon completing a delivery
	['party_exp_bonus'] = 15,		-- Bonus xp (in %) that each party member receives when completing a delivery
