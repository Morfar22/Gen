...
local qbJobGlobalControllers = { -- QB jobs that can access /hall is all areas.
    {'police', 2}, -- QB "dj" job with 2 grade level can access /hall in all areas.
    'police' -- QB "dj" job can access /hall in all areas regardless of grade level.
}

local qbJobAreaControllers = { -- QB jobs that can access /hall is specific areas.
    ['police'] = { -- Remove this to disable it, or add more entries as you wish.
        {'police', 2}, -- QB "unicorn" job with 2 grade level can access "vanilla_unicorn" area.
        'police' -- QB "dj" job can access /hall in "vanilla_unicorn" regardless of grade level.
    }
}
