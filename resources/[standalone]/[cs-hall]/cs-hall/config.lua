config = {
    ...
    -- If you want to host the DUI files yourself you can find the source at https://github.com/criticalscripts-shop/cs-hall-dui, otherwise leave it as it is.
    ['duiUrl'] = 'https://files.criticalscripts.shop/cs-hall-dui/dui.html',
