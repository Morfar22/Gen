Config = {
    ...
    Text = {
        BACK = "Tilbage",
        HIT = "Skyd",
        BALL_IN_HAND = "Grib bolden",
        BALL_IN_HAND_BACK = "Tilbage",
        AIM_LEFT = "Drej til venstre",
        AIM_RIGHT = "Drej til højre",
        AIM_SLOWER = "Langsomt sigte",
        ...
        BALL_IN_HAND_LEFT = 'Venstre',
        BALL_IN_HAND_RIGHT = 'Højre',
        BALL_IN_HAND_UP = 'Op',
        BALL_IN_HAND_DOWN = 'Ned',
        BALL_POCKETED = '%s Du sætter bolden i hullet',
        BALL_IN_HAND_NOTIFY = 'Du har poolbolden',
        BALL_LABELS = {
            [-1] = 'Cue',
            [1] = '~y~Solid 1~s~',
            [2] = '~b~Solid 2~s~',
