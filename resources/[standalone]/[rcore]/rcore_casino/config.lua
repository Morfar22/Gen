Config = {
    -- Map
    MapType = 2, -- 1 for rcore_casino_map, 2 for Gabz Casino (don't forget to disable rcore_casino_map and remove rcore_casino_map from fxmanifest.lua)
    ...
    SocietyName = "casino", -- id of the society (not a title, I guess, don't change it)
...
GameplayKeys = {
    TableGamesMaxBet = 44, -- Choose between: (204 is Tab, E is 46, 44 is Q)
