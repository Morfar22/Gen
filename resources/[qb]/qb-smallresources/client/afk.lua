                ...
                if prevPos ~= nil then
                    if currentPos == prevPos then
                        if time ~= nil then
                            if time > 0 then
                                if time == (900) then
                                    QBCore.Functions.Notify('Du er AFK du vil blive kicket om... ' .. math.ceil(time / 60) .. ' minutes!', 'error', 10000)
                                ...
                                elseif time == (150) then
                                    QBCore.Functions.Notify('Du er AFK du vil blive kicket om... ' .. math.ceil(time / 60) .. ' minutes!', 'error', 10000)
                                elseif time == (60) then
                                    QBCore.Functions.Notify('Du er AFK du vil blive kicket om... ' .. math.ceil(time / 60) .. ' minute!', 'error', 10000)
                                elseif time == (30) then
                                    QBCore.Functions.Notify('Du er AFK du vil blive kicket om... ' .. time .. ' seconds!', 'error', 10000)
                                elseif time == (20) then
                                    QBCore.Functions.Notify('Du er AFK du vil blive kicket om... ' .. time .. ' seconds!', 'error', 10000)
                                elseif time == (10) then
                                    QBCore.Functions.Notify('Du er AFK du vil blive kicket om... ' .. time .. ' seconds!', 'error', 10000)
