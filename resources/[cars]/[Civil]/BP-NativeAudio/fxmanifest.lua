...
game { 'gta5' }
name 'BP-NativeAudio'
description 'BestPixel - Native Audio & Vehicle Sounds'
author 'MeistroBurger#5843'
version '3.4.2'
...
data_file 'AUDIO_SOUNDDATA' 'audioconfig/surise_sounds.dat'
...
data_file 'AUDIO_WAVEPACK' 'sfx/dlc_vorstand'
data_file 'AUDIO_WAVEPACK' 'sfx/dlc_roxanne'
data_file 'AUDIO_WAVEPACK' 'sfx/dlc_velox'
data_file 'AUDIO_WAVEPACK' 'sfx/dlc_elegyrh7'
