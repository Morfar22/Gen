...
Config.ResourceName = "qb-core"

--- do not edit
--- https://tenor.com/view/knife-cat-threaten-gif-5482584
if Config.ResourceName == "" then
    if Config.Framework == 1 then
        Config.ResourceName = "es_extended"
    end
...
Config.DrunkList = {
    ...
    },
    {
        ...
        attachmentInfo = {
            ...
            -- because I cant get it working to fall on ground this will do for now.
            removeAfterThrow = true,
...
Config.EnablePlayer3DText = false
...
Config.DrinkTable = {
    {
        ...
        -- glass & bottle position from command /getrealposdrink
        Bottle = vector3(1975.86, 3818.92, 34.0),
        Glass = vec3(1975.859985, 3818.919922, 33.570004),

        -- Rotation of glass & bottle from command /getrealposdrink
        BottleRotation = 0.0,
        GlassRotation = 250.00077819824,
