...
Config.FrameworkTriggers = {
    load = '', --[ ESX = 'esx:playerLoaded' / QBCore = 'QBCore:Server:OnPlayerLoaded' ] Set the player load event, if left blank, default will be used
...
Config.FrameworkSQLTables = {
    table = '', --[ ESX = 'users' / QBCore = 'players' ] Set the name of the table where you players, if left blank, default will be used
    identifier = '', --[ ESX = 'identifier' / QBCore = 'citizenid' ] Set the identifier used in that table, if left blank, default will be used
}
...
Config.ZoneOptions = {
    ...
    rivalryCost = 4000, -- Minimum funds needed to start a rivalry in a zone
    rivalryDuration = 48, -- Rivalry duration in hours
    protectionMoney = 100, -- Minimum protection money in a business safe needed to be able to withdraw protection money
}

Config.GangOptions = {
    drugSell = true, -- Enable drug selling feature from gang menu
    drugSellGang = false, -- Enable drug selling feature only for gang members
    sellMoreDrugs = false, -- Sell more than one drug at a time (random number between 1 and sellDrugsQuantity)
    sellDrugsQuantity = 1, -- How many drugs per NPC players can sell

    gangColorsOnly = true, -- Only gang colors can be used on vehicle stored in gang garage
    garageCheckpoint = true, -- Enable garage checkpoint from gang menu
    storageCheckpoint = true, -- Enable storage checkpoint from gang menu

    robbing = true, -- Enable robbing feature from gang menu
    kidnapping = true, -- Enable kidnapping feature from gang menu

    ductTapeItem = '', -- Put name of the duct tape item in case you want to remove it from player's inventory
    paperBagItem = '', -- Put name of the paper bag item in case you want to remove it from player's inventory

    maxMembers = 6, -- Maximum amount of players in a gang
    minCopsForSell = 0, -- Minimum amount of cops on-duty needed for drug selling (You have to set the cop count by event)
}

Config.OtherOptions = {
    blackMoney = false, -- Receive black money instead of clean bills
...
Config.CommandSuggestion['ACCEPTGANG'] = {
    description = 'Use this to accept an invitation to gang.',
    parameters = {}
}
Config.CommandSuggestion['GANGMENU'] = {
    description = 'Use this to open gang menu.',
    parameters = {}
}
Config.CommandSuggestion['SHOWZONES'] = {
    description = 'Use this to show/hide zones on the map.',
    parameters = {}
}
Config.CommandSuggestion['SELLDRUGS'] = {
    description = 'Use this to open drug menu.',
    parameters = {}
}
