...
Config.SellItems = { -- Selling Prices
	...
	['emerald_necklace'] = 105,
	['ruby_necklace'] = 110,
	['sapphire_necklace'] = 115,
...
Config.Items = {
    ...
    items = {
	[1] = { name = "water_bottle", price = 3, amount = 100, info = {}, type = "item", slot = 1, },
	[2] = { name = "sandwich", price = 4, amount = 250, info = {}, type = "item", slot = 2, },
	[3] = { name = "bandage", price = 5, amount = 100, info = {}, type = "item", slot = 3, },
	[4] = { name = "weapon_flashlight", price = 6, amount = 100, info = {}, type = "item", slot = 4, }, 
	[5] = { name = "drill",	price = 1100, amount = 100, info = {}, type = "item", slot = 5, }, 
	[6] = { name = "handdrill",	price = 400, amount = 100, info = {}, type = "item",	slot = 6, },
	[7] = { name = "drillbit", price = 30, amount = 100,	info = {}, type = "item", slot = 7, }, }		
}
