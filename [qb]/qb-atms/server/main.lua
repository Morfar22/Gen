...
CreateThread(function()
    while true do
        Wait(3600000)
        dailyWithdraws = {}
        TriggerClientEvent('QBCore:Notify', -1, "Nulstilling af daglig tilbagetrækningsgrænse", "success")
    end
end)
        ...
        if dailyWith < Config.DailyLimit then
            ...
            if xCH ~= nil then
                ...
                if bankCount > 0 then
                    ...
                    TriggerClientEvent('QBCore:Notify', src, "Hævet $" .. data.amount .. ' fra kreditkort. Daglige tilbagetrækninger: ' .. dailyWithdraws[cardHolder], "success")
                else
            ...
            TriggerClientEvent('QBCore:Notify', src, "Du har nået den daglige grænse", "error")
        end
    end
end)
