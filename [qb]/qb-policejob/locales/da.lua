local Translations = {
    ...
    info = {
        ...
        poobject_object = 'Objekttype at spawn eller \'delete\' at slette',
        ...
        tow_driver_paid = 'Du betalte bugserbilchaufføren',
        paid_lawyer = 'Du har betalt en advokat',
        vehicle_taken_depot = 'Køretøj taget til depot for $%{price}',
        vehicle_seized = 'Køretøj beslaglagt',
        stolen_money = 'Du har stjålet $%{stolen}',
        cash_robbed = 'Du er blevet bestjålet for $%{money}',
        ...
        cash_found = 'Fundet $%{cash} på den civile',
        sent_jail_for = 'Du sendte personen i fængsel i %{time} måneder',
        fine_received = 'Du har modtaget en bøde på $%{fine}',
        ...
        bill = 'Bill',
        amount = 'Beløb',
        police_plate = 'LSPD', --Bør kun være 4 tegn langt
        ...
        store_heli = '[E] Butikshelikopter',
        take_heli = '[E] Tag Helikopter',
        impound_veh = '[E] - Beslaglagt køretøj',
        store_veh = '[E] - Butikskøretøj',
        armory = 'Armory',
        ...
        new_call = 'Nyt opkald',
        officer_down = 'Betjent %{efternavn} | %{callsign} nede'
    },
    evidence = {
        red_hands = 'Røde hænder',
        wide_pupils = 'Brede pupiler',
        red_eyes = 'Røde øjne',
        weed_smell = 'Lufter af ukrudt',
        krudt = 'krudt i tøj',
        kemikalier = 'Lugter af kemikalier',
        heavy_breathing = 'Trækker vejret tungt',
        sved = 'sveder meget',
        handbleed = 'Blod på hænder',
        confused = 'Forvirret',
        alkohol = 'Lugter af alkohol',
    ...
    email = {
        afsender = 'Central Retlige Inddrivelsesmyndighed',
        subject = 'Inkasso',
        besked = 'Kære %{value}. %{value2}, <br /><br />Central Judicial Collection Agency (CJCA) opkrævede de bøder, du modtog fra politiet.<br />Der er <strong>$%{value3}</strong> trukket tilbage fra din konto.<br /><br />Med venlig hilsen<br />Hr. I.K. Graai',
    },
    commands = {
        ...
        kaldesignal = 'Giv dig selv et kaldesignal',
        ...
        softcuff = 'Blød manchet (kun politiet)',
        camera = 'Se sikkerhedskamera (kun politiet)',
        flagplade = 'Flag en plade (kun politiet)',
